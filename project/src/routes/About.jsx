            ...
            <div style={{display:'grid', gap:12}}>
                <div style={{padding:16, border:'1px solid #eee', borderRadius:16}}>
                    ...
                    <ul style={{margin:0, paddingLeft:18}}>
                        ...
                        <li>Beautiful detail page with badges and links</li>
                ...
                <div style={{padding:16, border:'1px solid #eee', borderRadius:16}}>
                    ...
                    <ul style={{margin:0, paddingLeft:18}}>
                        <li>React + Vite</li>
                        <li>react-router-dom (multi-page UX)</li>
                        <li>Fetch API + simple state management with hooks</li>
                    </ul>
                </div>
                ...
                <div style={{padding:16, border:'1px solid #eee', borderRadius:16}}>
                    ...
                    <p style={{margin:0}}>
                        This app uses the FreeToGame API (free to use; attribution required). <br />
                        Source:&nbsp;
